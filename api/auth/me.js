...
<p style="margin-top:20px;font-size:12px;color:#94a3b8">Pour ne plus recevoir ces emails : <a href="https://emploia.fr/legal/cgu" style="color:#94a3b8">Se désabonner</a></p>`
      )).catch(() => {});
    }
  }
