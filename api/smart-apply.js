  ...
  try {
    const res = await withTimeout(fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 2500,
        system: [{ type: 'text', text: 'Tu es un expert en candidature et rédaction professionnelle pour le marché français. Tu génères des dossiers de candidature complets et percutants. Réponds uniquement en JSON valide.', cache_control: { type: 'ephemeral' } }],
