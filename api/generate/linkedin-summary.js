...
import { checkRateLimit, sanitizeString, getAllowedOrigin, withTimeout, getCurrentUser, incrementGenerations, getGenerationsUsed, FREE_LIMIT, htmlEscape } from '../_lib/auth.js';
